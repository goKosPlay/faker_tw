...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $cites = array("基隆市", "台北市", "新北市", "桃園縣", "新竹市",
        "新竹縣", "苗栗縣", "台中市", "彰化縣", "南投縣",
        "雲林縣", "嘉義市", "嘉義縣", "台南市", "高雄市",
        "屏東縣", "台東縣", "花蓮縣", "宜蘭縣", "澎湖縣",
        "金門縣", "連江縣");
    ...
    protected static $street = array("中正路", "中山路", "民生路", "中華路", "和平路",
        "中興路", "仁愛路", "復興路", "民族路", "民權路",
        "忠孝路", "信義路", "成功路", "新興路", "忠孝街",
        "和平街", "信義街", "仁愛街", "文化路", "大同路",
        "三民路", "新生路", "光復路", "自強路", "光明路",
    ...
    {
        return $this->postcode().  $this->city()  . static::street();
    }
